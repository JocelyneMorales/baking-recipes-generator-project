...
function generateRecipe(event) {
  ...
  let prompt = `User instructions: Create a simple but detailed baking recipe for ${instructionsInput}. The recipe should include a list of ingredients, step-by-step instructions, and any special tips or variations that can enhance the final product`;
